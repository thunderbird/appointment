...
const pageDescriptionHelpLabel = computed(
  () => `${pageDescription.value?.length.toString() ?? 0}/${MAX_DESCRIPTION_LENGTH}`
);
...
<template>
  ...
  <div class="fields-container">
    <!-- Page name -->
    <text-input class="page-name-input" type="text" name="pageName" v-model="pageName" required>
      {{ t('label.pageName') }}:
    </text-input>
