...
import {
  ...
  DateFormatStrings, EventLocationType, MeetingLinkProviderType,
} from '@/definitions';
import {
...
import {
  BubbleSelect, CheckboxInput, LinkButton, PrimaryButton, SwitchToggle, TextInput, SelectInput
...
<template>
  <div class="flex flex-col gap-4">
    ...
    <!-- step 1 -->
    <div id="schedule-availability" class="schedule-creation-step">
    ...
    <!-- step 2 -->
    <div id="schedule-settings" class="schedule-creation-step">
      <div class="flex flex-col gap-3">
        <hr/>
