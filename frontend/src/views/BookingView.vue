<template>
  <!-- fixed header -->
  <header class="fixed h-24 w-full shadow-lg bg-white border-b border-gray-300 flex gap-4 items-center">
  ...
  <main class="max-w-screen-2xl mx-auto pt-32 flex justify-between items-start select-none">
  ...
  <footer class="fixed bottom-0 h-24 w-full bg-white border-t border-gray-300">
