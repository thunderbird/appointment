...
export const isOIDCAuthKey = Symbol('isOIDCAuth') as InjectionKey<boolean>;

// OIDC Auth Manager
export const oidcUserManagerKey = Symbol('oidcUserManager') as InjectionKey<UserManager>;
