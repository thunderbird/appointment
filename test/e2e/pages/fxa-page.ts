...
import { APPT_LOGIN_PWORD, TIMEOUT_10_SECONDS, TIMEOUT_1_SECOND, TIMEOUT_30_SECONDS } from '../const/constants';
...
export class FxAPage {
  ...
  async signIn() {
    ...
    await this.passwordInput.fill(String(APPT_LOGIN_PWORD), { timeout: TIMEOUT_30_SECONDS });
