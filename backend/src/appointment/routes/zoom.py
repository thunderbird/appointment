...
def zoom_callback_error(is_setup: bool, error: str):
    ...
    return RedirectResponse(
        f'{os.getenv("FRONTEND_URL", "http://localhost:8090")}/settings/connectedAccounts?error={error}'
    )
...
def zoom_callback(
    ...
    return RedirectResponse(f'{os.getenv("FRONTEND_URL", "http://localhost:8090")}/settings/connectedAccounts')
